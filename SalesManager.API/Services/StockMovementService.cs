...
namespace SalesManager.API.Services
{
    public class StockMovementService : IStockMovementService
    {
        ...
        public async Task InsertAsync(StockMovement stockMovement)
        {
            ...
            stockMovement.MovementValue = stockMovement.MovementType == MovementType.Compra ? ((stockMovement.UnitaryValue * stockMovement.Quantity) * -1) : (price * stockMovement.Quantity);
